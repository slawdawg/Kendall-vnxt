...
- `pnpm run test:local-verification-contracts`, `pnpm run test:local-verification-state-store`, and `pnpm run test:local-verification-lifecycle` verify the autonomous local verification plan, bounded receipt evidence, and owned lifecycle controls
...
- Pipeline Coordination Health operator guide: [docs/workflows/pipeline-coordination-health.md](docs/workflows/pipeline-coordination-health.md)
