...
- Add `pnpm run test:e2e:dashboard:controls` for the controls-page evidence-report slice.
...
- The focused controls-page e2e script exists and is listed by the verification readiness report.
