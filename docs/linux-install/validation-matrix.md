...
| Manual Auth blocker fixture | `docs/linux-install/fixtures/goal-run/blocker-manual-auth.json` | Repo | Manual Auth blocker records exact required user action, resume command, dependency impact, continued safe task, and secrets exclusion | None |
