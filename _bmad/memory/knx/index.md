...
- Optional source/evidence validator: scaffolded, structurally validated, safety-reviewed, hardened for synthetic fixtures, source packet examples, fixture/source-packet, source inventory, work trace, validation evidence, decision-record, user-input-required, output metadata/storage-boundary, fixture artifact-ID, generated-artifact, and decision-record reference contract checks, and held as local installable packaging evidence.
...
- Latest substantive KNX governance commit: `b3e1bea Cover ksev decision record references`
