...
- Optional source/evidence validator: scaffolded, structurally validated, safety-reviewed, hardened for synthetic fixtures, source packet examples, packet-level boundary flags, fixture/source-packet, source inventory, work trace, validation evidence, decision-record, user-input-required, output metadata/storage-boundary, fixture artifact-ID, decision artifact-ID, generated-artifact, decision-record, and superseded-decision reference contract checks, and held as local installable packaging evidence.
...
- Latest substantive KNX governance commit: `c1bd39d Cover ksev decision artifact ids`
