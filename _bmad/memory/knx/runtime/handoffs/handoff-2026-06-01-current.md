...
- Latest scoped local implementation commit: `c598a14 Cover ksev generated artifact references`.
...
- `ksev` unit tests: 61 passed.
- Synthetic fixture validation: PASS, 15 fixtures, 0 findings.
