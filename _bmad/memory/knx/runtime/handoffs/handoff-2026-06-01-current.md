...
- Latest scoped local implementation commit: `bdac627 Cover ksev validator run evidence bundles`.
...
- `ksev` unit tests: 70 passed.
- Synthetic fixture validation: PASS, 17 fixtures, 0 findings.
