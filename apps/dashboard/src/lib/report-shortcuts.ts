export const reportAnchorByEndpoint: Record<string, string> = {
  ...
  "GET /work-items/{id}/runtime-evidence-export": "#runtime-evidence-review-report",
  "GET /supervisor/safe-development-backlog": "#safe-development-backlog",
  "GET /supervisor/runner-assignment-status-report": "#runner-assignment-status",
  ...
  "GET /supervisor/trusted-delivery-eligibility-report": "#trusted-delivery-eligibility-report",
  ...
  "GET /supervisor/review-resource-policy-report": "#review-resource-policy-report",
