...
**Python is the default** for all script logic in supported Linux development environments. See `references/script-standards.md` for full rationale and safe bash commands.
