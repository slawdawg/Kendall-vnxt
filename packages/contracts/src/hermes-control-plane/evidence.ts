...
const DELIVERY_EVIDENCE_FIELDS = [
  "deliveryEvidenceId", "outcomeId", "laneRunId", "schemaVersion", "evidenceType", "summary", "sourceRef",
...
export function isDeliveryEvidenceV1(value: unknown): value is DeliveryEvidenceV1 {
  return guardFailsClosed(() => {
    ...
    return isDeliveryEvidenceId(value.deliveryEvidenceId) && isHermesOutcomeId(value.outcomeId) && isHermesLaneRunId(value.laneRunId) &&
