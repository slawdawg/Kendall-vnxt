...
// Verification records are emitted only by the Supervisor's typed handoff
// transaction. They remain typed for persisted projections, but a public
// lifecycle envelope cannot claim that transition.
const EXTERNALLY_ACCEPTED_LIFECYCLE_EVENT_NAMES = Object.freeze([
  "hermes.outcome.created",
  "hermes.lane.recovered",
  "hermes.delivery.denied",
  "hermes.external-impact.requested",
