export const HERMES_REQUIRED_FIELDS_BY_CONTRACT = Object.freeze({
  ...
  HermesCitedSourceRecordV1: Object.freeze(["sourceRecordId", "outcomeId", "laneRunId", "schemaVersion", "sourceKind", "locator", "fingerprint", "citationRefs", "accessScope", "confidence", "observedAt", "reviewAt", "expiresAt", "supersedesSourceRecordId", "idempotencyKey", "expectedOutcomeRevision", "expectedLaneRevision", "metadataOnly", "rawPayloadRetained"] as const),
  HermesCitedSourceConfirmationReceiptV1: Object.freeze(["receiptId", "consumerType", "consumerId", "outcomeId", "laneRunId", "citedSourceRecordIds", "sourceSetFingerprintSha256", "expectedOutcomeRevision", "expectedLaneRevision", "confirmedAt", "metadataOnly", "rawPayloadRetained"] as const),
...
export const HERMES_SERIALIZED_FIELDS_BY_CONTRACT = Object.freeze({
  ...
  HermesCitedSourceRecordV1: Object.freeze(["source_record_id", "outcome_id", "lane_run_id", "schema_version", "source_kind", "locator", "fingerprint", "citation_refs", "access_scope", "confidence", "observed_at", "review_at", "expires_at", "supersedes_source_record_id", "idempotency_key", "expected_outcome_revision", "expected_lane_revision", "metadata_only", "raw_payload_retained"] as const),
  HermesCitedSourceConfirmationReceiptV1: Object.freeze(["receipt_id", "consumer_type", "consumer_id", "outcome_id", "lane_run_id", "cited_source_record_ids", "source_set_fingerprint_sha256", "expected_outcome_revision", "expected_lane_revision", "confirmed_at", "metadata_only", "raw_payload_retained"] as const),
