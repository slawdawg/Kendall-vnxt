export const HERMES_REQUIRED_FIELDS_BY_CONTRACT = Object.freeze({
  ...
  VerificationRecordV1: Object.freeze(["verificationRecordId", "outcomeId", "laneRunId", "schemaVersion", "result", "target", "sourceFingerprint", "developerIdentity", "developerHome", "developerWorkspace", "evidenceRefs", "observedAt", "idempotencyKey", "createdAt", "metadataOnly", "rawPayloadRetained", "expectedOutcomeRevision", "expectedLaneRevision"] as const),
  ...
  HermesUnavailableReviewerBlockV1: Object.freeze(["unavailableReviewerBlockId", "verificationRecordId", "outcomeId", "developerLaneRunId", "schemaVersion", "expectedOutcomeRevision", "expectedLaneRevision", "reasonCode", "nextAction", "evidenceRefs", "observedAt", "idempotencyKey", "createdAt", "metadataOnly", "rawPayloadRetained"] as const),
} as const);
...
export const HERMES_SERIALIZED_FIELDS_BY_CONTRACT = Object.freeze({
  ...
  VerificationRecordV1: Object.freeze(["verification_record_id", "outcome_id", "lane_run_id", "schema_version", "result", "target", "source_fingerprint", "developer_identity", "developer_home", "developer_workspace", "evidence_refs", "observed_at", "idempotency_key", "created_at", "metadata_only", "raw_payload_retained", "expected_outcome_revision", "expected_lane_revision"] as const),
  ...
  HermesUnavailableReviewerBlockV1: Object.freeze(["unavailable_reviewer_block_id", "verification_record_id", "outcome_id", "developer_lane_run_id", "schema_version", "expected_outcome_revision", "expected_lane_revision", "reason_code", "next_action", "evidence_refs", "observed_at", "idempotency_key", "created_at", "metadata_only", "raw_payload_retained"] as const),
} as const);
...
export const HERMES_UNAVAILABLE_REVIEWER_BLOCK_V1_REQUIRED_FIELDS = HERMES_REQUIRED_FIELDS_BY_CONTRACT.HermesUnavailableReviewerBlockV1;
...
export const HERMES_UNAVAILABLE_REVIEWER_BLOCK_V1_SERIALIZED_FIELDS = HERMES_SERIALIZED_FIELDS_BY_CONTRACT.HermesUnavailableReviewerBlockV1;
