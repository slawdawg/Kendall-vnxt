export const HERMES_REQUIRED_FIELDS_BY_CONTRACT = Object.freeze({
  HermesOutcomeV1: Object.freeze(["outcomeId", "taskId", "schemaVersion", "title", "summary", "status", "result", "reasonCode", "evidenceRefs", "nextAction", "observedAt", "idempotencyKey", "createdAt", "updatedAt", "metadataOnly", "rawPayloadRetained"] as const),
  HermesLaneRunV1: Object.freeze(["laneRunId", "outcomeId", "taskId", "schemaVersion", "laneType", "status", "result", "reasonCode", "evidenceRefs", "nextAction", "heartbeatAt", "staleDeadlineAt", "timeoutAt", "retryBudget", "reworkBudget", "evidenceFingerprint", "observedAt", "idempotencyKey", "createdAt", "updatedAt", "metadataOnly", "rawPayloadRetained"] as const),
  DeliveryEvidenceV1: Object.freeze(["deliveryEvidenceId", "outcomeId", "laneRunId", "taskId", "schemaVersion", "evidenceType", "summary", "sourceRef", "observedAt", "evidenceRefs", "idempotencyKey", "createdAt", "metadataOnly", "rawPayloadRetained"] as const),
...
export const HERMES_SERIALIZED_FIELDS_BY_CONTRACT = Object.freeze({
  HermesOutcomeV1: Object.freeze(["outcome_id", "task_id", "schema_version", "title", "summary", "status", "result", "reason_code", "evidence_refs", "next_action", "observed_at", "idempotency_key", "created_at", "updated_at", "metadata_only", "raw_payload_retained"] as const),
  HermesLaneRunV1: Object.freeze(["lane_run_id", "outcome_id", "task_id", "schema_version", "lane_type", "status", "result", "reason_code", "evidence_refs", "next_action", "heartbeat_at", "stale_deadline_at", "timeout_at", "retry_budget", "rework_budget", "evidence_fingerprint", "observed_at", "idempotency_key", "created_at", "updated_at", "metadata_only", "raw_payload_retained"] as const),
  DeliveryEvidenceV1: Object.freeze(["delivery_evidence_id", "outcome_id", "lane_run_id", "task_id", "schema_version", "evidence_type", "summary", "source_ref", "observed_at", "evidence_refs", "idempotency_key", "created_at", "metadata_only", "raw_payload_retained"] as const),
