...
export const PIPELINE_IMPLEMENTATION_READINESS_EVIDENCE = [
  ...
  },
  {
    ...
    requiredTokens: [
      ...
      { file: "apps/dashboard/src/lib/pipeline-packet-loader.ts", tokens: ["getWorkPackets", "pipelinePacketsWithPersistedGovernedWorkerEvidence", "Supervisor packets"] },
  ...
  },
  {
    ...
    sourceFiles: ["tests/dashboard-pipeline-fixtures.test.mjs", "apps/dashboard/src/lib/pipeline-packet-loader.ts", "apps/dashboard/src/lib/pipeline-fixtures.ts"],
    requiredTokens: [
