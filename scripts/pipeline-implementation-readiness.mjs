...
export const PIPELINE_IMPLEMENTATION_READINESS_EVIDENCE = [
  {
    ...
    sourceFiles: ["packages/contracts/src/work-packet.ts", "apps/dashboard/src/lib/pipeline/pipeline-fixture-contract.ts", "apps/dashboard/src/lib/pipeline-fixtures.ts", "tests/work-packet-contracts.test.mjs", "tests/dashboard-pipeline-fixtures.test.mjs"],
    requiredTokens: [
      { file: "packages/contracts/src/work-packet.ts", tokens: ["export interface WorkPacketV0View", "export interface MemoryProposalV0"] },
      { file: "apps/dashboard/src/lib/pipeline/pipeline-fixture-contract.ts", tokens: ["PIPELINE_FIXTURE_SCHEMA_VERSION", "dashboard-pipeline-fixture/v1", "export type PipelineFixturePacketV1", "isPipelineFixturePacketV1"] },
      { file: "apps/dashboard/src/lib/pipeline-fixtures.ts", tokens: ["PipelineFixturePacketV1", "schemaVersion: \"dashboard-pipeline-fixture/v1\"", "sourceKind: \"demo-fixture\""] },
      { file: "tests/work-packet-contracts.test.mjs", tokens: ["metadata-only evidence", "MemoryProposalV0"] },
      { file: "tests/dashboard-pipeline-fixtures.test.mjs", tokens: ["dashboard-pipeline-fixture/v1", "isPipelineFixturePacketV1", "parallel dashboard model"] },
    ],
    summary: "Shared Work Packet and Memory Proposal contracts remain available as nested detail holds, while /pipeline/demo fixture packets use a strict dashboard-pipeline-fixture/v1 DTO with an explicit fixture-only detail extension.",
  },
  {
