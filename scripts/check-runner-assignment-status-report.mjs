...
for (const browserText of [
  ...
  "dispatcher-closed-source-guard-source-kind-summary-refresh: assignable (backlog-assignable)",
  "Assignment row filters",
  "Source completion",
...
for (const supervisorTestText of [
  ...
  'dispatcher_closed_source_guard_source_kind_summary_backlog["classification"] == "assignable"',
  'source_kind_summary_backlog["reasonCode"] == "backlog-closed-source-assignment"',
  'source_kind_summary_backlog["sourceCompletionEvidence"]',
