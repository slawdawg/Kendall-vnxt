...
for (const browserText of [
  ...
  "dispatcher-closed-source-guard-filter-presets-refresh: assignable (backlog-assignable)",
  "Assignment row filters",
  "Source completion",
...
for (const supervisorTestText of [
  ...
  'dispatcher_closed_source_guard_filter_presets_backlog["classification"] == "assignable"',
  'filter_presets_backlog["reasonCode"] == "backlog-closed-source-assignment"',
  'filter_presets_backlog["sourceCompletionEvidence"]',
