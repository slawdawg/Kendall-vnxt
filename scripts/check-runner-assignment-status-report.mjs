...
for (const browserText of [
  ...
  "Rows: workspace \\d+, lane assignment 0, backlog 0",
  ...
  "Showing \\d+\\/\\d+ rows for active from Workspace with all source-completion states",
  ...
  "Showing \\d+\\/\\d+ rows for closed from Lane assignment with all source-completion states",
]) {
