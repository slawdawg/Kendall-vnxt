...
for (const browserText of [
  ...
  "dispatcher-closed-source-guard-filter-empty-state-shortcut-counts-refresh: assignable (backlog-assignable)",
  "Assignment row filters",
  "Source completion",
...
for (const supervisorTestText of [
  ...
  'dispatcher_closed_source_guard_filter_empty_state_shortcut_counts_backlog["classification"] == "assignable"',
  'filter_empty_state_shortcut_counts_backlog["reasonCode"] == "backlog-closed-source-assignment"',
  'filter_empty_state_shortcut_counts_backlog["sourceCompletionEvidence"]',
