...
for (const browserText of [
  ...
  "dispatcher-closed-source-guard-rollup-filter-refresh: assignable (backlog-assignable)",
  "Assignment row filters",
...
for (const supervisorTestText of [
  ...
  'dispatcher_closed_source_guard_rollup_filter_backlog["classification"] == "assignable"',
  'rollup_filter_backlog["reasonCode"] == "backlog-closed-source-assignment"',
  'rollup_filter_backlog["sourceCompletionEvidence"]',
