...
for (const browserText of [
  ...
  "dispatcher-closed-source-guard-filter-empty-state-shortcuts-refresh: assignable (backlog-assignable)",
  "Assignment row filters",
  "Source completion",
...
for (const supervisorTestText of [
  ...
  'dispatcher_closed_source_guard_filter_empty_state_shortcuts_backlog["classification"] == "assignable"',
  'filter_empty_state_shortcuts_backlog["reasonCode"] == "backlog-closed-source-assignment"',
  'filter_empty_state_shortcuts_backlog["sourceCompletionEvidence"]',
