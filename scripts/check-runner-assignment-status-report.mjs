...
for (const browserText of [
  ...
  "dispatcher-closed-source-guard-rollup-refresh: assignable (backlog-assignable)",
  "Assignment row filters",
...
for (const supervisorTestText of [
  ...
  'dispatcher_closed_source_guard_rollup_backlog["classification"] == "assignable"',
  'rollup_backlog["reasonCode"] == "backlog-closed-source-assignment"',
  'rollup_backlog["sourceCompletionEvidence"]',
