...
const targetPath = path.join(repoRoot, "tests", "e2e", "supervisor-managed-mobile-recipe.spec.ts");
const title = process.env.KENDALL_WORK_ITEM_TITLE?.trim() || "Supervisor-managed mobile dashboard recipe";
