...
assertCondition(
  runtimeExportCheck.includes("docs/stories/3-51-process-lifecycle-policy-drift-check.md"),
  "Runtime evidence export drift check must require Story 3.51 git-backed evidence",
  failures,
);
assertCondition(
  serviceSource.includes("docs/stories/3-51-process-lifecycle-policy-drift-check.md"),
...
assertCondition(
  runbookCheck.includes("pnpm run check:process-lifecycle"),
  "Runbook drift check must require pnpm run check:process-lifecycle",
  failures,
);
assertCondition(
