...
assertCondition(
  supervisorTests.includes('report_alignment_item["status"] == "closed"') &&
    ...
    supervisorTests.includes('"codex/dispatcher-closed-source-guard-filter-reset-refresh"') &&
    supervisorTests.includes('node ./scripts/codex-workspace.mjs start "dispatcher closed source guard filter reset refresh"') &&
    ...
    supervisorTests.includes('dispatcher_closed_source_guard_rollup_filter_item["status"] == "closed"') &&
    supervisorTests.includes('dispatcher_closed_source_guard_source_kind_summary_item["status"] == "closed"') &&
    supervisorTests.includes('dispatcher_closed_source_guard_filter_reset_item["status"] == "ready"'),
