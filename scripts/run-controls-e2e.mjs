...
const dbPath = (process.env.PLAYWRIGHT_E2E_DB_PATH ?? join(dataDir, `e2e-supervisor-controls-${process.pid}.db`)).replaceAll("\\", "/");
...
try {
  ...
  const playwrightArgs = [
    ...
    "dashboard.spec.ts",
    "--grep",
    "shows compact routing fleet data on controls",
  ];
