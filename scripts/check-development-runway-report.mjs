...
for (const serviceText of [
  ...
  "Use completed report and evidence navigation work as source evidence only",
  "Use the completed keyboard-loop item as evidence only",
  ...
  "Use this completed authority approval scope readiness evidence only",
...
assertCondition(
  controlsPageContent.includes("<DevelopmentRunwayReportPanel report={data.developmentRunwayReport} />"),
  "Controls page content must render DevelopmentRunwayReportPanel",
  failures,
);
assertCondition(
