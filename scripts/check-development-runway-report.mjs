...
for (const serviceText of [
  ...
  "Select this slice for dispatcher closed source guard filter empty-state shortcut reason focus work",
...
for (const testText of [
  ...
  'node ./scripts/codex-workspace.mjs start "dispatcher closed source guard filter empty state shortcut reason focus refresh"',
  "pnpm run check:runner-assignment-status",
  "pnpm run check:safe-backlog",
  '"verification-runbook-hardening-slice"',
  '"authority-blocker-maintenance-slice"',
