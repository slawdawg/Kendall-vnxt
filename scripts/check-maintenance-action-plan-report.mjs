...
assertCondition(
  controlsPageContent.includes("<MaintenanceActionPlanReportPanel report={data.maintenanceActionPlanReport} />"),
  "Controls page content must render MaintenanceActionPlanReportPanel",
  failures,
);
assertCondition(
