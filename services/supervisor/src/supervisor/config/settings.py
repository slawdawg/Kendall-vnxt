...
class Settings(BaseSettings):
    ...
    ollama_connect_timeout_seconds: int = Field(default=5, alias="SUPERVISOR_OLLAMA_CONNECT_TIMEOUT_SECONDS")
    ollama_total_timeout_seconds: int = Field(default=30, alias="SUPERVISOR_OLLAMA_TOTAL_TIMEOUT_SECONDS")
