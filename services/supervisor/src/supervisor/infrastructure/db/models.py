...
class HermesDeliveryEvidence(Base):
    ...
    reviewed_head_sha: Mapped[str | None] = mapped_column(String(40), nullable=True)
    observed_at: Mapped[datetime] = mapped_column(UtcDateTime())
    evidence_refs_json: Mapped[list] = mapped_column(JSON)
...
class HermesDeliveryAdmission(Base):
    ...
    delivery_steward_identity: Mapped[str | None] = mapped_column(String(120), nullable=True)
    delivery_home: Mapped[str | None] = mapped_column(String(240), nullable=True)
    delivery_workspace: Mapped[str | None] = mapped_column(String(240), nullable=True)
    delivery_capability_binding_id: Mapped[str | None] = mapped_column(String(120), nullable=True)
    requested_reviewer: Mapped[str | None] = mapped_column(String(39), nullable=True)
