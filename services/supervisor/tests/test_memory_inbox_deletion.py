...
async def test_only_all_proven_registered_copies_terminally_delete_an_approved_source(tmp_path) -> None:
    ...
    async with async_sessionmaker(engine, expire_on_commit=False)() as session:
        ...
        manifests = [MemoryInboxManifest(id="manifest:delete-one", owner_revision_id=revision.id, copy_class="quarantine", store_ref="inbox-store:delete-one", creation_state="Created", retention_class="source_retention", deletion_state="None"), MemoryInboxManifest(id="manifest:delete-two", owner_revision_id=revision.id, copy_class="preview", store_ref="inbox-store:delete-two", creation_state="Created", retention_class="source_retention", deletion_state="None"), MemoryInboxManifest(id="manifest:delete-proposal", owner_revision_id=proposal_revision.id, copy_class="proposal_body", store_ref="inbox-store:delete-proposal", creation_state="Created", retention_class="proposal_retention", deletion_state="None")]
